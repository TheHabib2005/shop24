        ...
        <header className='py-6'>
            <div className='flex items-center justify-between '>
                ...
                <div className=' md:w-1/3 flex-1 flex items-center gap-x-6 justify-end'>
                    {/* //user icon */}
                    <Link href={""} className='w-12 h-12 bg-gray-100 md:flex hidden items-center justify-center rounded-full dark:bg-zinc-900 dark:text-white' >
                    ...
                    {/* wishlist icon */}
                    <Link href={""} className='w-12 h-12 md:flex bg-gray-100 hidden items-center justify-center rounded-full dark:bg-zinc-900 dark:text-white cursor-pointer' >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-7">
                    ...
                    {/* cart icon */}
                    <div className=' w-12 h-12 bg-[#2563EB] text-white flex  items-center justify-center rounded-full cursor-pointer ' onClick={() => {
