        ...
        <div className="font-[sans-serif] bg-zinc-950  h-screen">
            <div className="w-full   lg:grid  flex flex-col-reverse lg:grid-cols-7  h-screen overflow-y-scroll">
                ...
                <div className="col-span-3  border-l border-zinc-700 lg:pt-5 pt-10 px-5 max-w-full">
                    <Link href={""} className="flex  mt-6 items-center w-full gap-3">
                        <div className="bg-zinc-800 p-1  relative rounded-md">
                            ...
                            <img
                                src="http://localhost:3000/google-tshirt.png"
                                className="w-[80px] "
                                alt=""
                            />
                        </div>
                        <div className="flex items-center    w-full justify-between ">
                            ...
                            <span className="text-lg font-semibold text-zinc-400">$ 200</span>
                        </div>
                    </Link>
